...
public class StatisticsTest {
    ...
    public void getGamesRatioTest() {
        assertEquals(Math.round((2.0D / 6.0D) * 100.0D), Math.round(statistics.getGamesRatio()));
        statistics = new Statistics("username", 0, 0, 0, 0, 0);
        assertEquals(Math.round(0.0F), Math.round(statistics.getGamesRatio()));
    }
    ...
    public void getUsernameTest() {
        assertEquals("username", statistics.getUsername());
    }
